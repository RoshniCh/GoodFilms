          ...
          <Container className="navbar-style">
            ...
            <Collapse className="d-sm-inline-flex flex-sm-row-reverse navbar-style" isOpen={!this.state.collapsed} navbar>
              <ul className="navbar-nav flex-grow navbar-style">
                ...
                <NavItem>
                  <NavLink tag={Link} className="text-dark" to="/AddMovie">Update Movie</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={Link} className="text-dark" to="/DiscoverLanguage">Discover by Langauge</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={Link} className="text-dark" to="/fetch-data">Discover by Genre</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink tag={Link} className="text-dark" to="/fetch-data">Search Movies</NavLink>
                </NavItem>
                <LoginMenu>
                </LoginMenu>
              </ul>
